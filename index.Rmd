...
```{r mgcv_graph, echo=F, eval=T, cache=F, dependson=-1}
...
Often the goal is to find latent structure among the observations (rows), as opposed to the variables (columns).  As such we have another unsupervised modeling situation that is very commonly used- cluster analysis.  
