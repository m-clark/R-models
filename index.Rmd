...
Preference is given to base R functionality or what are perceived as very commonly used packages.  'Very common' is based on my own knowledge consulting across dozens of disciplines and universities, regularly following the R community, and things like the rankings at [RDocumentation.org](https://rdocumentation.org) and packages listed in [CRAN Task Views](https://www.rdocumentation.org/taskviews).
