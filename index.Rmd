...
adist(word_vec1, word_vec2)                         # string distance between sets of words
...
```{r text_stringr}
str_extract(word_vec, pattern = 'xyz')
