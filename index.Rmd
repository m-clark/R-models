...
For those who want to get more into the implementation of many of these models, I have raw R code for many (probably most) of the techniques discussed [here](https://github.com/m-clark/Miscellaneous-R-Code).
...
lavaan_perc = get_perc('lavaan')
lavaan_survey_perc = get_perc('lavaan_survey')
...
piecwiseSEM_perc = get_perc('piecwiseSEM')
...
- <span class="basepack">blavaan</span> `r blavaan_perc`%
- <span class="basepack">lavaanPlot</span> `r lavaanPlot_perc`%
- <span class="basepack">semTools</span> `r semTools_perc`%
- <span class="basepack">regsem</span> `r regsem_perc`%
- <span class="basepack">mediation</span> `r mediation_perc`%
- <span class="basepack">piecwiseSEM</span> `r piecwiseSEM_perc`%
- <span class="basepack">MplusAutomation</span> `r MplusAutomation_perc`%
- <span class="basepack">lava</span> `r lava_perc`%
- <span class="basepack">OpenMx</span> `r OpenMx_perc`%
- <span class="basepack">psych</span> `r psych_perc`%
